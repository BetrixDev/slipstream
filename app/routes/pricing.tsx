      ...
      <div className="relative overflow-hidden bg-transparent">
        ...
        <div className="flow-root z-20 bg-transparent pb-24 sm:pb-32 mt-4">
          <div className="px-4 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-8 lg:gap-4">
              {tiers.map((tier) => (
                <div
                  key={tier.name}
                  className={cn(
...
function PriceButton({ tier, interval }: PriceButtonProps) {
  ...
  return (
    <Button
      ...
      disabled={userAccountTier !== "free" && tier.id !== userAccountTier}
    >
...
const tiers: PricingTier[] = [
  ...
  },
  {
    ...
    description: "For content creators and enterprises",
    icon: (
      <Star className="w-7 h-7 relative z-10 text-gray-500 dark:text-gray-400 animate-[float_3s_ease-in-out_infinite]" />
    ),
    features: [
      {
        name: "Everything in Premium Tier",
        description: "You get all the features of the premium tier",
      },
      {
        name: "50TB of storage space",
        description: "You can upload up to 50TB of videos",
      },
      {
      ...
      },
      {
        ...
        description: "Customize the player with your brand",
      },
    ],
  },
];
